      ...
      <div class="table-responsive">
           <table class="table table-bordered">
                <tr>
                     ...
                     <th width="60%">Answer 1</th>
                     <th width="60%">Answer 2</th>
                     <th width="60%">Answer 3</th>
                     <th width="60%">Answer 4</th>
                     <th width="60%">Answer 5</th>
                     <th width="60%">Answer 6</th>
                     <th width="60%">Image</th>
                     <th width="60%">Latitude</th>
                     <th width="60%">Longitude</th>
                     <th width="60%">Public</th>
                     <th width="60%">Spam</th>
